...
var damage_popup_node = preload("res://scenes/enemy/ui/damage.tscn")
...
var drop = preload("res://scenes/etc/XPDrop.tscn")
...
var elite : bool = false:
	set(value):
		elite = value
		if value:
			$Sprite2D.material = load("res://assets/Shaders/RainbowShader.tres")
